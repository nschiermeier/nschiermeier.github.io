...
We also went over Jensen's Inequality, which was talked about in 200A, but not explained too well. This inequality states that if $g$ is a convex function, then $E[g(x)] \geq g(E[X])$, provided that the expectation exists. I think this diagram helps show it: 

![Jensen's Inequality Graph](posts/Images/jenson.png)
...
I think I'm also going to redefine this section of my blog. Instead of making it just what I did this week, I'm just going to have it be a weekly soapbox, and write about anything that's been on my mind for the week. I think that will also give these blogs more of a personality.

I have to say, I'm pretty happy that I was able to get this first week blog out on time! Well, I guess at the time of publishing, it'll be Monday of Week 2 since it's after midnight, but close enough. I really think adding the MathJax / LaTeX support helped a ton, because it's so much easier and more fluent to type. There's also a lot more I'm able to do, and I know it'll look way nicer on the website as well. The only thing I haven't tested yet is the photo, so I'm just hoping that will look good when finally published. I also realized since I have three-day weekends, I can split the writing into one class/day, which should make things more manageable, and also then review my notes over a longer period of time. I know this blog is going to be very long, as there was a lot of information, so I might have to see how to trim the fat on upcoming blogs to only be the most important stuff from each class.

Other than that, I got a surprising text that a friend from Purdue will be visiting San Diego during my school's spring break! I really look forward to seeing him, as he was someone I grew incredibly close to as an RA at Purdue, and because it'll be a nice excuse to visit San Diego in late March.